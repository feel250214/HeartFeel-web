...
/** uploadFileVO POST /api/file/upload/vo */
export async function uploadFileVoUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.uploadFileVOUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseUploadFileVO_>('/api/file/upload/vo', {
    method: 'POST',
    params: {
      ...params,
    },
