...
import com.HeartFeel.maker.generator.main.GenerateTemplate;
import com.HeartFeel.maker.generator.main.ZipGenerator;
import com.HeartFeel.maker.meta.Meta;
import com.HeartFeel.maker.meta.MetaValidator;
...
import com.HeartFeel.web.model.dto.generator.*;
...
import com.HeartFeel.web.service.GeneratorService;
...
public class GeneratorController {
    ...
    public BaseResponse<Page<GeneratorVO>> listGeneratorVOByPage(@RequestBody GeneratorQueryRequest generatorQueryRequest,
        ...
        queryWrapper.select("id", "status", "picture", "description", "tags", "userId", "createTime", "updateTime");
    ...
    public void useGenerator(@RequestBody GeneratorUseRequest generatorUseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // 执行脚本
        // 找到脚本文件所在路径
        // windows下查找.bat, 其他系统直接找generator
...
//        String[] commands = new String[]{scriptAbsolutePath, "json-generate", "--file=" + dataModelFilePath};
    ...
    private static String getPageCacheKey(GeneratorQueryRequest generatorQueryRequest){
        String base64 = JSONUtil.toJsonStr(generatorQueryRequest);
